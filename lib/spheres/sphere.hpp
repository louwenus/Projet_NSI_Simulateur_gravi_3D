...
public:
    ...
    virtual bool collsion(lco speed,u_short dur,std::list<DummySphere*> &fragments) = 0;       //retourne true si la sphere est détruite
...
public:
    ...
    virtual bool collsion(lco speed,u_short dur,std::list<DummySphere*> &fragments);
