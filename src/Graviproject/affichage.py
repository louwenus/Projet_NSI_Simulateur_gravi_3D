...
class Controles(QWidget):
    ...
    def ajouter_spheres(boo:bool) -> None:
        for i in range(Controles.amount.value()):
            ...
            var = gravilib.PyBaseSphere (randint(xmin,xmax)*10, randint(ymin,ymax)*10, randint(-2000,2000), randint(10000,100000), randint(3000,10000), randint(0,100), randint(0,100), randint(0,10),10)
